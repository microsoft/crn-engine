...
import * as SpatialRunner from '../Adapters/ModellingEngineSpatial2DSimulationRunner';
import SpatialViewer from '../../../../HTML5SharedGUI/SimulationViewer/Scripts/Spatial2DViewer';
...
export interface ISimulationRunner {
    SimulateModel(crn: crn.IG, nodeId: string, server: boolean): Rx.Observable<SimViewer.IVisualizationUpdateMessage>;
    Abort(): void;
}
