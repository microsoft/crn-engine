...
import * as TimeseriesView from "./Spatial2DTimeseriesView";
import * as TableView from "./Spatial2DTableView";
import * as Settings from "./SpatialViewerSettings";
import "jqueryui";
import * as template from 'raw-loader!../html/Spatial2DTemplate.html';
...
class Viewer extends Framework.FilteredViewCollection {
    ...
    public bind(elem: HTMLElement) {
        ...
        this.timeseries.Bind($("spatial-simulation-2d", $_elem).get(0));
        this.table.Bind($("spatial-2d-table-view", $_elem).get(0));
    }
}
