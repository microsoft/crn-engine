...
open PublishHelper
#load "../CRNEngineWebServer/BuildSettings.fs"

let copyRequiredFilestoOutput projectDir outDir configuration =
    copySundials projectDir outDir configuration
    copyWebStuff projectDir outDir CRNEngineWebServer.BuildSettings.homeFolder
    copyJobStuff projectDir outDir CRNEngineWebServer.BuildSettings.jobsFolder
...
//Example:
//dotnet fake build --target Publish ProjectDir="E:\dev\biocomputing\CRNEngine\CRNEngineWebServer\" PublishDir="bin\Debug\netcoreapp3.0\publish\"  Configuration=Debug
