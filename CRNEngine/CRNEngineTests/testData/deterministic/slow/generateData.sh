...
for i in ./*crn; do timeout $T $BME Sundials -points 100 -simulate "$i" && echo $MSG; done
for i in ./*crn; do timeout $T $BME SundialsStiff -points 100 -simulate "$i" && echo $MSG; done
